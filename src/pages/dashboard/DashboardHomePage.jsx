      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-1.5 text-sm text-gray-600">
            Welcome to the management area. Monitor projects, donations, beneficiaries,
            and recent activity.
          </p>
        </div>
      ...
      {isAdmin && (
        <Card className="rounded-[24px] p-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="text-base font-bold text-gray-900">Administration</h2>
              <p className="mt-1 text-sm text-gray-500">
                User approvals and staff account management now have their own admin-only
                workspace.
              </p>
            </div>
